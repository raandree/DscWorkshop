...
FunctionsToExport = @('Get-RelativeFileName', 'ConvertTo-Datum', 'Get-DatumRSOP','Get-FileProviderData','Get-MergeStrategyFromPath','Invoke-TestHandlerAction','Merge-Datum','New-DatumFileProvider','New-DatumStructure','Resolve-Datum','Resolve-DatumPath','Test-TestHandlerFilter')
...
PrivateData = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = '## [0.39.1-preview0002] - 2021-01-01
